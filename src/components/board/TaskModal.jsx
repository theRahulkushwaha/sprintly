      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-5">
                  ...
                  {priorities.map((p) => (
                    <button
                      ...
                      className={`text-xs px-2.5 py-1 rounded-full border transition-all capitalize ${
                        priority === p
                          ? priorityColors[p]
                          : "text-white/20 bg-white/3 border-white/8 hover:border-white/20"
                      }`}
                    >
                      {p}
                    </button>
            ...
            {/* Description */}
            <div>
              <label className="text-white/25 text-xs uppercase tracking-wider mb-2 block">
                Description
              </label>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <label className="text-white/25 text-xs uppercase tracking-wider">
                  Comments (
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-white/5">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 text-sm text-white/30 hover:text-white/60 bg-white/5 rounded-xl transition-all"
              >
                Cancel
              </button>
