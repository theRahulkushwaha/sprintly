    ...
    <>
      ...
      >
        ...
        <div className="h-full overflow-y-auto overflow-x-hidden flex flex-col">
          ...
          {activeWorkspace && (
            <div className="px-4 py-4 border-b border-white/5 shrink-0">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white/40 text-[11px] uppercase tracking-[0.15em]">
                  Workspace
                </span>
              </div>
          ...
          {/* USER */}
          <div className="border-t border-white/5 p-3 shrink-0 bg-[#0a0a0f]">

            <div className="flex items-center gap-3 px-2 py-2 rounded-2xl bg-white/[0.03] border border-white/5">

              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white text-sm font-bold uppercase shrink-0">
